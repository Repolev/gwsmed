...
<?php $__env->startSection('meta_title', $category->title); ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cv-breadcrumb-box">
                        <h1><?php echo e(ucfirst($category->title)); ?></h1>
                        <ul>
                            <li><a href="<?php echo e(route('home')); ?>">Home</a></li>
                            <li>Subcategory</li>
                            <li><?php echo e(ucfirst($category->title)); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <?php $__currentLoopData = $category->subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cv-product-box cv-product-item cv-hand">
                                <div class="cv-product-img">
                                    <img src="<?php echo e(asset($subcat->image_path)); ?>" alt="image"
                                         class="img-fluid" />
                                </div>
                                <div class="cv-product-data">
                                    <a href="<?php echo e(route('product.category',$subcat->slug)); ?>" class="cv-price-title"><?php echo e(ucfirst($subcat->title)); ?></a>
                        ...
                        <div class="cv-gallery-grid">
                            <?php $__currentLoopData = $category->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="cv-product-box cv-product-item cv-hand">
                                    ...
                                    ?>
                                    <div class="cv-product-img">
                                        <img src="<?php echo e(asset($photo[0])); ?>" alt="<?php echo e($item->title); ?>"
                                             class="img-fluid" />
                                        <div class="cv-product-button">
                                            <a href="<?php echo e(route('product.detail',$item->slug)); ?>" class="cv-btn"><svg
                                                ...
                                                View detail</a>
                                            <a href="javascript:;" data-id="<?php echo e($item->id); ?>" data-quantity="1" class="add_to_cart cv-btn" id="add_to_cart<?php echo e($item->id); ?>">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(document).on('click','.add_to_compare',function (e) {
            ...
            var path = "<?php echo e(route('compare.store')); ?>";
            $.ajax({
                url: path,
                type: "POST",
                dataType: "JSON",
    ...
    <script>
        $(document).on('click', '.add_to_wishlist', function (e) {
            ...
            var token = "<?php echo e(csrf_token()); ?>";
            var path = "<?php echo e(route('wishlist.store')); ?>";
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\All_projects\indian_friend\gwsmed\resources\views/frontend/pages/product/product-subcategory.blade.php ENDPATH**/ ?>