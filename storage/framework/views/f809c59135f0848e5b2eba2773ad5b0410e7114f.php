                ...
                <div class="col-lg-12">
                    <div class="cv-shop-box">
                        <div class="cv-shop-title">
                            ...
                            <p><span>Total : </span><?php echo e($products->total()); ?></p>
                        </div>
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="cv-product-box cv-product-item cv-hand">
                                            <div class="cv-product-img">
                                                <img src="<?php echo e($product->image_path); ?>" alt="image"
                                                     class="img-fluid" />
                                            ...
                                            <div class="cv-product-data">
                                                <a href="<?php echo e(route('product.detail',$product->slug)); ?>" class="cv-price-title"><?php echo e(ucfirst($product->title)); ?></a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwsmedco/gws.gwsmed.com/resources/views/frontend/pages/product/search-product.blade.php ENDPATH**/ ?>