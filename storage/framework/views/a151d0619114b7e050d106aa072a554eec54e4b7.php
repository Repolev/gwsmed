                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cv-foot-box cv-foot-logo">
                        <?php if(\App\Models\Setting::value('logo')): ?>
                            <img src="<?php echo e(asset('frontend/assets/images/logo.svg')); ?>" alt="image" class="img-fluid"/>
                        <?php else: ?>
                            <img src="<?php echo e(Helper::defaultLogo()); ?>" alt="image" class="img-fluid"/>
                        <?php endif; ?>
                        <p><?php echo e(\App\Models\Setting::value('short_intro')); ?></p>
                    ...
                    <div class="cv-foot-box cv-foot-links">
                        ...
                        <ul>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route('product.category', $category->slug)); ?>"><?php echo e($category->title); ?></a></li>
...
<!-- Share this end -->
<?php /**PATH C:\All_projects\indian_friend\gwsmed\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>