							...
							<div class="col-md-6">
                                <div class="cv-blog-box">
                                    ...
                                    <div class="cv-blog-data">
                                        ...
                                        <a href="<?php echo e(route('blog.detail',$post->slug)); ?>" class="cv-blog-title"><?php echo e($post->title); ?></a>
                                       <a href="<?php echo e(route('blog.detail',$post->slug)); ?>" > <p><?php echo html_entity_decode($post->summary); ?></p></a>
				  ...
				  <div class="col-md-12">
                                <div class="cv-pagination">
                                    <!--<ul>
                                        ...
                                        <li><a href="javascript:;" class="cv-page-active">1</a></li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwsmedco/email.gwsmed.com.gwsmed.com/resources/views/frontend/pages/blog.blade.php ENDPATH**/ ?>