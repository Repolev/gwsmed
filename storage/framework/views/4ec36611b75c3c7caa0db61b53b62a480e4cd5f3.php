...
<?php $__env->startSection('meta_title', $product->title); ?>
                ...
                <div class="col-12">
                    <div class="cv-breadcrumb-box">
                        ...
                        <ul>
                            ...
                            <li><?php echo e(ucfirst($product->title)); ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="product__details__images">
                                ...
                                <div id="sync1" class="owl-carousel owl-theme thumbnail-slider">
                                    <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <img src="<?php echo e(asset($photo)); ?>" alt="Product Detail Image">
                                        </div>
                                ...
                                <div id="sync2" class="owl-carousel owl-theme">
                                    <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="item">
                                            <img src="<?php echo e(asset($photo)); ?>" alt="Product Detail">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                        ...
                        <div class="col-sm-7">
                            <div class="cv-prod-content">
                                <h2 class="cv-price-title"><?php echo e(ucfirst($product->title)); ?></h2>
                                <div class="cv-prod-category">
                                    <span>Product Model : <span style="font-weight: 700"><?php echo e($product->model_no); ?></span></span>

                                </div>
                                <div class="cv-prod-category my-3">
                                    <span>Category :</span>
                                    <?php $__currentLoopData = $product->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('product.category',$category->slug)); ?>" style="font-weight: 700" class="cv-prod-category"><?php echo e($category->title); ?><?php if(!$loop->last): ?>,<?php endif; ?></a>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                               <div class="mt-3">
                                   <div class="cv-prod-count">
                                       <div class="cv-cart-quantity">
                                           <button data-id="<?php echo e($product->id); ?>" class="cv-sub"></button>
                                           <input data-id="<?php echo e($product->id); ?>" type="number" class="qty-text" min="1" value="1">
                                           <button data-id="<?php echo e($product->id); ?>" class="cv-add"></button>
                                       </div>
                                       <a href="javascript:void(0);" data-product_id="<?php echo e($product->id); ?>" data-quantity="1" class="mr-2 cv-btn add_to_cart_button_details" id="add_to_cart_button_details_<?php echo e($product->id); ?>">add to cart</a>
                                                       ...
                                                       <div class="row">
                                                           <div class="col-md-12">
                                                               <div class="form-group">
                                                                   ...
                                                                   <input type="text" name="subject" placeholder="Subject" class="form-control" value="<?php echo e($product->title); ?>">
                                ...
                                <div class="swiper-wrapper">
                                    <?php $__currentLoopData = $product->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(count($cat->products)>0): ?>
                                            <?php $__currentLoopData = $cat->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        $('.add_to_cart_button_details').on('click',function () {
            ...
            $.ajax({
                ...
                beforeSend:function () {
                    $('#add_to_cart_button_details_<?php echo e($product->id); ?>').html('<i class="fas fa-spinner fa-spin"></i> Loading...');

                },
                complete:function () {
                    $('#add_to_cart_button_details_<?php echo e($product->id); ?>').html('Add To Cart');
                },
    ...
    <script>
        ...
        $('.add_to_cart_button_details').on('click',function () {
            ...
            $.ajax({
                ...
                beforeSend:function () {
                    $('#add_to_cart_button_details_<?php echo e($product->id); ?>').html('<i class="fa fa-spinner fa-spin"></i> Loading...');
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\All_projects\indian_friend\gwsmed\resources\views/frontend/pages/product/product-detail.blade.php ENDPATH**/ ?>