                                ...
                                <div class="swiper-slide">
                                    <div class="cv-product-box">
                                        <div class="cv-product-img">
                                            ...
                                            ?>
                                            <img src="<?php echo e(asset($photos[0])); ?>" alt="<?php echo e($item->image_alt); ?>" class="img-fluid"/>
                                            <div class="cv-product-button">
                                                <a href="<?php echo e(route('product.detail',$item->slug)); ?>" class="cv-btn">
                                        ...
                                        <div class="cv-product-data">
                                            ...
                                            <p>Model No: <span style="font-weight: bold;color:#AB292B;"><?php echo e(\Illuminate\Support\Str::upper($item->model_no)); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4 category-block">
                    <div class="cv-deal-box" <?php if($cat->image_path != null): ?> style="background-image: url(<?php echo e(url($cat->image_path)); ?>); background-size: cover;" <?php endif; ?>>
                        <div class="overlay" style="color:white!important; ">
                            ...
                            <p ><?php echo html_entity_decode(\Illuminate\Support\Str::limit($cat->description,400)); ?></p>
                            <a href="<?php echo e(route('product.category.' . $cat->level, $category_url)); ?>" class="cv-btn">readmore</a>
                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwsmedco/gws.gwsmed.com/resources/views/frontend/index.blade.php ENDPATH**/ ?>