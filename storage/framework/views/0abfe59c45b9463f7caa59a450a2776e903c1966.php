                        ...
                        <ul>
                            <li>
                                ...
                                <div class="cv-contact-text">
                                    <h3>Contact</h3>
                                    <p><?php echo e(\App\Models\Setting::value('phone')); ?></p>
                                </div>
                            </li>
                            <li>
                                <div class="cv-contact-icon">
                                ...
                                <div class="cv-contact-text">
                                    <h3>Email</h3>
                                    <p><?php echo e(\App\Models\Setting::value('email')); ?></p>
                            ...
                            <li>
                                ...
                                <div class="cv-contact-text">
                                    <h3>Location</h3>
                                    <p><?php echo e(\App\Models\Setting::value('address')); ?></p>
                            ...
                            <li>
                                ...
                                <div class="cv-contact-text">
                                    <h3>Open Time</h3>
                                    <p><?php echo e(\App\Models\Setting::value('office_time')); ?></p>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\All_projects\indian_friend\gwsmed\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>