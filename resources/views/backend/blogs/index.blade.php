                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Blogs
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('blogs.create')}}"><i class="icon-plus"></i> Add Blog</a></h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($blogs as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('blogs.edit',$item->id)}}" data-toggle="tooltip" title="edit" class="float-left btn btn-sm btn-outline-warning" data-placement="bottom"><i class="fas fa-edit"></i> </a>
                                                <form class="float-left ml-1" action="{{route('blogs.destroy',$item->id)}}"  method="post">
                                                    @csrf
                                                    @method('delete')
