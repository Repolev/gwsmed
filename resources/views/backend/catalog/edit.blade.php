        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Edit Catalog</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form action="{{route('catalogs.update',$category->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Catalog Name" name="name" value="{{$category->name }}" id="productTitle">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <label for="">Catalog URL<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="catalog-slug" name="slug" value="{{ $category->slug }}" id="productSlug">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="photo" class="dropify" data-height="150" data-default-file="{{asset($category->image_path)}}"/>
                                        </div>
                                    </div>
