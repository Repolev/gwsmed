...
@section('content')
    ...
    <!-- breadcrumb start -->
    <div class="cv-breadcrumb " style="@if($product->categories->whereNotNull('banner_path')->last() !=null) background: url('{{asset($product->categories->whereNotNull('banner_path')->last()->banner_path)}}'); @endif">
    </div>
...
{{--                            <li><a href="{{route('home')}}">{{$product->category['title']}}</a></li>--}}
                        ...
                        <li><a href="{{ route('product.category.' . $category->level, $category->full_slug) }}">{{ $category->title }}  @if(!$loop->last)|@endif</a></li>
                        @endforeach
...
{{--                            <a class="nav-link" data-toggle="tab" href="#cv-pro-enquiry" role="tab" aria-selected="true">Enquiry</a>--}}
                        ...
                        <div class="tab-content cv-tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active pt-4" style="border:1px solid #ddd" id="cv-pro-description">
                        ...
                        <div class="col-12">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    @foreach($product->reverseCategories as $cat)
