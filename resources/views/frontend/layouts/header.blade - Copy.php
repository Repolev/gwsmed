        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-9">
                    <div class="cv-logo">
                        <a href="{{ URL::to('/') }}"><img src="{{ URL::to('/') }}/frontend/images/logo.PNG" alt="image" class="img-fluid"/></a>
                    </div>
                </div>
                    ...
                    <div class="cv-nav-bar">
                        <div class="cv-menu">
                            <ul>
                                            ...
                                            <li class=" cv-children-menu {{Request::path()=='home' ? 'active' : ''}}"><a href="{{route('home')}}">Home</a></li>
                                            <li class="cv-children-menu {{Request::path()=='about-us' ? 'active' : ''}}"><a href="{{route('about-us')}}">About Us</a></li>
                                            <!--<li class="cv-children-menu @if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">Products</a><span class="new">New</span></li>	-->

                                          {{Helper::getHeaderCategory()}}											
                                               
                                            <li class="cv-children-menu {{Request::path()=='blog' ? 'active' : ''}}"><a href="{{route('blog')}}">Blog</a></li>									
                                               
                                            <li class="cv-children-menu {{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('contact')}}">Contact Us</a></li>
