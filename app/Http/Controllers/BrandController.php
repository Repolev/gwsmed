...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            ...
            'photo'=>'required|image|mimes:png,jpg,jpeg,svg,gif,svg',
        ...
        if($request->hasFile('photo')){
            if($file=$request->file('photo')){
                ...
                $file->storeAs('public/backend/assets/images/brand/', $imageName);
                $data['photo']=$imageName;
                $data['image_path']='storage/backend/assets/images/brand/'.$imageName;
            }
        }
