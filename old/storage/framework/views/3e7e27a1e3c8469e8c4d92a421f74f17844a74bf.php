...
unset($__errorArgs, $__bag); ?>
		 ...
		 <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="slug" placeholder="Enter Url"  value="<?php echo e($category->slug); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
		 ...
		 <div class="form-group">
          <label for="summary" class="col-form-label">Meta Title</label> <span class="text-danger">*</span>
          <textarea class="form-control" id="meta_title" name="meta_title"><?php echo e($category->meta_title); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
		...
		<div class="form-group">
          <label for="summary" class="col-form-label">Meta Description</label> <span class="text-danger">*</span>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwsmedco/email.gwsmed.com.gwsmed.com/resources/views/backend/category/edit.blade.php ENDPATH**/ ?>