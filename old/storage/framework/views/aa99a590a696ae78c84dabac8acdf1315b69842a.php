                ...
                <div class="col-lg-12">
                    <div class="cv-blog-single-box">
                        ...
                        <div class="cv-blog-data">
                            <a href="javascript:;" class="cv-blog-date"><?php echo e($post->created_at->format('M d, Y')); ?></a>
                            <h2 class="cv-blog-title"><?php echo e($post->title); ?></h2>
                           <?php if($post->quote): ?>
                    ...
                    <div class="cv-blog-comment">
                        <h2 class="cv-sidebar-title">Comment (<?php echo e($post->allComments->count()); ?>)</h2>
                        <ul>
                            <li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gwsmedco/email.gwsmed.com.gwsmed.com/resources/views/frontend/pages/blog-detail.blade.php ENDPATH**/ ?>