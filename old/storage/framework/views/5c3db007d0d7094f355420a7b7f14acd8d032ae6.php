...
<div class="cv-top-header-two">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="cv-head-email">
                        <h3>Email : example@medical.com</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-7">
                    <div class="cv-logo">
                         <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(URL::to('/')); ?>/frontend/images/logo.png" alt="image" class="img-fluid"/></a>
                    </div>
                </div>
                    ...
                    <div class="cv-nav-bar">
                        <div class="cv-menu">
						               <ul>
                                            ...
                                            <li class=" cv-children-menu <?php echo e(Request::path()=='home' ? 'active' : ''); ?>"><a href="<?php echo e(route('home')); ?>">Home</a></li>
                                            <li class="cv-children-menu <?php echo e(Request::path()=='about-us' ? 'active' : ''); ?>"><a href="<?php echo e(route('about-us')); ?>">About Us</a></li>
                                            <!--<li class="cv-children-menu <?php if(Request::path()=='product-grids'||Request::path()=='product-lists'): ?>  active  <?php endif; ?>"><a href="<?php echo e(route('product-grids')); ?>">Products</a><span class="new">New</span></li>	-->

                                          <?php echo e(Helper::getHeaderCategory()); ?>											
                                               
                                            <li class="cv-children-menu <?php echo e(Request::path()=='blog' ? 'active' : ''); ?>"><a href="<?php echo e(route('blog')); ?>">Blog</a></li>									
                                               
                                            <li class="cv-children-menu <?php echo e(Request::path()=='contact' ? 'active' : ''); ?>"><a href="<?php echo e(route('contact')); ?>">Contact Us</a></li>
	...
	<?php /**PATH /home/gwsmedco/email.gwsmed.com.gwsmed.com/old/resources/views/frontend/layouts/header.blade.php ENDPATH**/ ?>