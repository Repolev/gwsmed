                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Brands
                            <a class="btn btn-sm btn-outline-secondary" href="{{route('brand.create')}}"><i class="icon-plus"></i> Add Brand</a></h2>
                        <ul class="breadcrumb float-left">
                            <li class="breadcrumb-item"><a href="{{route('admin')}}"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">Brand</li>
                        </ul>
                        <p class="float-right">Total Banners :{{\App\Models\Brand::count()}}</p>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($brands as $item)
                                        <tr>
                                            ...
                                            <td>{{$item->slug}}</td>
                                            <td><img src="{{asset($item->image_path)}}" alt="banner image" style="max-height: 90px; max-width: 120px"></td>
                                            <td>
